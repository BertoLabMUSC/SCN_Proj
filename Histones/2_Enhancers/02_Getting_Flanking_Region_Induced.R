...
dir.create("Induced_Flanking_Region/")
...
# Getting the flanking region for 30 min Ligth Stimulation Genes
genes = read.table("inputs/Dge_Time/Increase_halfhr_total.txt", header = T)
...
write.table(df,"Induced_Flanking_Region/min30_50kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)

df <- data.frame(seqnames=seqnames(flanking_100kb),
starts=start(flanking_100kb)-1,
ends=end(flanking_100kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/min30_100kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)


# Getting the flanking region for 1 hr Ligth Stimulation Genes
genes = read.table("inputs/Dge_Time/Increase_1hr_unique.txt", header = T)
...
ends=end(flanking_50kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/hr01_50kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)

df <- data.frame(seqnames=seqnames(flanking_100kb),
starts=start(flanking_100kb)-1,
ends=end(flanking_100kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/hr01_100kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)


# Getting the flanking region for 3 hr Ligth Stimulation Genes
genes = read.table("inputs/Dge_Time/Increase_3hr_unique.txt", header = T)
...
ends=end(flanking_50kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/hr03_50kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)

df <- data.frame(seqnames=seqnames(flanking_100kb),
starts=start(flanking_100kb)-1,
ends=end(flanking_100kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/hr03_100kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)


# Getting the flanking region for 6 hr Ligth Stimulation Genes
genes = read.table("inputs/Dge_Time/Increase_6hr_unique.txt", header = T)
...
ends=end(flanking_50kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/hr06_50kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)

df <- data.frame(seqnames=seqnames(flanking_100kb),
starts=start(flanking_100kb)-1,
ends=end(flanking_100kb),
gene=transcripts$mgi_symbol)
write.table(df,"Induced_Flanking_Region/hr06_100kb_Flanking.bed",sep="\t",row.names=F,col.names=F,quote=F)
