...
prom <- promoters(genes, upstream=2000,downstream=100)
...
write.table(promoters,"Promoter_All_Genes_2kb.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% rownames(finalgenes),] %>%
             ...
             arrange(seqnames)
write.table(tmp,"min30_2kb_Prom_Induced.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% finalgenes$Gene,]%>%
             select(-width,-tx_name) %>%
             arrange(seqnames)
write.table(tmp,"hr01_2kb_Prom_Induced.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% finalgenes$Gene,]%>%
             select(-width,-tx_name) %>%
             arrange(seqnames)
write.table(tmp,"hr03_2kb_Prom_Induced.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% finalgenes$Gene,]%>%
             select(-width,-tx_name) %>%
             arrange(seqnames)
write.table(tmp,"hr06_2kb_Prom_Induced.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% finalgenes$Gene,]%>%
             select(-width,-tx_name) %>%
             arrange(seqnames)
write.table(tmp,"hr01_2kb_Prom_Reduced.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% finalgenes$Gene,]%>%
             select(-width,-tx_name) %>%
             arrange(seqnames)
write.table(tmp,"hr03_2kb_Prom_Reduced.bed",sep="\t",row.names=F,col.names=F,quote=F)
...
tmp <- promoters[promoters$Gene %in% finalgenes$Gene,]%>%
             select(-width,-tx_name) %>%
             arrange(seqnames)
write.table(tmp,"hr06_2kb_Prom_Reduced.bed",sep="\t",row.names=F,col.names=F,quote=F)